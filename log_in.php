...
if (isset($_POST['submit'])) {
  ...
  if (mysqli_num_rows($select_users) > 0) {
    $row = mysqli_fetch_assoc($select_users);
      ...
      mysqli_query($conn,  "INSERT INTO user_activity_status (user_id, status, timestamp) VALUES ('$user_id', 'online', NOW()) ON DUPLICATE KEY UPDATE status='online', timestamp=NOW()");
