...
if (isset($_GET['id'])) {
  ...
  $row = mysqli_fetch_assoc($select_user_query);
      ...
      if (isset($_POST['edit_profile'])) {
        ...
        mysqli_query($conn, "UPDATE `users` SET name='$name', last_name='$last_name', email='$email', adress='$adress', number='$number', profession='$profession' WHERE id=$user_id") or die('query failed');
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $row['adress'] ; ?></div>
                  </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form   action="" method="post" novalidate>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="adress" type="text" class="form-control" id="Address" value="<?php echo $row['adress']; ?>">
                      </div>
                    </div>
