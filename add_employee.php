    ...
    if (mysqli_num_rows($select_users) > 0) {
        $message[] = 'User already exists!';
          ...
          // if everything is ok, try to upload file
            ...
            mysqli_query($conn, "INSERT INTO `users`(name, last_name, email, number, adress, dob, entry_day, photo, role, password) VALUES('$name', '$last_name', '$email', '$number', '$adress', '$dob', '$entry_day', ' $target_file', '$role', '$hashed_password')") or die('query failed');
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form  class="row g-3"  action="" name="add_employee" method="post" enctype="multipart/form-data" novalidate>
                <div class="col-md-6">
